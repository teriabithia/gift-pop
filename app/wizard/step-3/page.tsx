      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-4">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-base text-gray-600">Let us know your budget and any special preferences</p>
          </div>

          <div className="space-y-6">
            <div className="space-y-3">
              <h2 className="text-lg font-semibold text-gray-900">
                Budget Range <span className="text-gray-400 text-sm font-normal">(optional)</span>
              </h2>
            ...
            <div className="space-y-3">
              <h2 className="text-lg font-semibold text-gray-900">
                Special Preferences <span className="text-gray-400 text-sm font-normal">(optional)</span>
              </h2>
              <Textarea
                ...
                className="min-h-[80px] resize-none text-sm p-3 border-2 border-gray-200 rounded-lg focus:border-purple-500"
              />
            ...
            <div className="flex justify-between pt-4">
              ...
              <Button onClick={handleGetResults} className="px-6 py-2 text-sm bg-purple-600 hover:bg-purple-700">
