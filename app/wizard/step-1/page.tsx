...
export default function WizardStep1() {
  ...
  useEffect(() => {
    // 如果有 reset 参数，清空之前的数据
    if (searchParams.get('reset') === 'true') {
      clearData()
      setRelationship("")
      setGender("")
    }
  }, [searchParams, clearData])
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-4">
          ...
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Who are you shopping for?</h1>
            <p className="text-base text-gray-600">Tell us about your relationship to help us find the perfect gift</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <h2 className="text-lg font-semibold text-gray-900">
                Gender <span className="text-gray-400 text-sm font-normal">(optional)</span>
              </h2>
            ...
            <div className="flex justify-between pt-4">
              <Button variant="outline" disabled className="px-6 py-2 text-sm bg-transparent">
                Previous
              </Button>
              <Button
                onClick={handleNext}
